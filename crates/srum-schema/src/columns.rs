...
static ENERGY_USAGE_COLS: &[SrumColumnDef] = &[
    ...
    SrumColumnDef {
        column_id: 12,
        name: "ActiveDcOnBatteryTime",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 13,
        name: "CsDcOnBatteryTime",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 14,
        name: "ActiveDischargeTime",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 15,
        name: "CsDischargeTime",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 16,
...
static APP_TIMELINE_COLS: &[SrumColumnDef] = &[
    ...
    SrumColumnDef {
        column_id: 10,
        name: "CompRenderedDuration",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 11,
        name: "CompDirtyDuration",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 12,
        name: "CompPropagatedDuration",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 13,
        name: "AudioInDuration",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 14,
        name: "AudioOutDuration",
        coltyp: 4,
    },
    SrumColumnDef {
        column_id: 15,
        name: "NetworkBytesRaw",
        coltyp: 15,
    },
    SrumColumnDef {
        column_id: 16,
    ...
    SrumColumnDef {
        column_id: 17,
        name: "NetworkTailBytesRaw",
        coltyp: 15,
    },
    SrumColumnDef {
        column_id: 18,
        name: "MBBTailBytesRaw",
        coltyp: 15,
    },
    SrumColumnDef {
        column_id: 19,
